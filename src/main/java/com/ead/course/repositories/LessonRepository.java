...
@Repository
public interface LessonRepository extends JpaRepository<LessonModel, UUID>, JpaSpecificationExecutor<CourseModel> {
    ...
    //@Param: para evitar erros se estiver fora de ordem as query com os parametros
}
